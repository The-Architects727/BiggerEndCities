...
package net.architects.morestructuresmod.Generator;
...
//                }
    ...
    static {
        ...
        SMALL_TOWER = new Part() {
            ...
            public boolean create(StructureTemplateManager manager, int depth, Piece root, BlockPos pos, List<StructurePiece> pieces, Random random) {
                ...
                if (piece2 != null && random.nextBoolean()) {
                    ...
                    while(var14.hasNext()) {
                        ...
                        if (random.nextBoolean() || random.nextBoolean() || ifBig(random) || ifBig(random)) {
                            ...
                            BiggerEndCityGenerator.createPart(manager, BiggerEndCityGenerator.BRIDGE_PIECE, depth + 1, piece3, (BlockPos)null, pieces, random);
                        }
                    }
                    ...
                    if (depth != (ModConfigs.MAX_DEPTH - 1)) {
                        return BiggerEndCityGenerator.createPart(manager, BiggerEndCityGenerator.FAT_TOWER, depth + 1, piece, (BlockPos)null, pieces, random);
                    }
        ...
        BRIDGE_PIECE = new Part() {
            ...
            public boolean create(StructureTemplateManager manager, int depth, Piece root, BlockPos pos, List<StructurePiece> pieces, Random random) {
                ...
                if (!this.shipGenerated && random.nextInt(40 - depth) == 0) {
                ...
                for(int i = 0; i < ModConfigs.MAX_FAT_TOWERS && random.nextInt(ModConfigs.MAX_FAT_TOWERS) != 0; ++i) {
                    ...
                    while(var10.hasNext()) {
                        ...
                        if (random.nextBoolean() || random.nextBoolean() || ifBig(random) || ifBig(random)) {
                            ...
                            BiggerEndCityGenerator.createPart(manager, BiggerEndCityGenerator.BRIDGE_PIECE, depth + 1, piece2, (BlockPos)null, pieces, random);
                        }
                    }
                }
    ...
    public static class Piece extends SimpleStructurePiece {
        ...
        public Piece(StructureTemplateManager manager, NbtCompound nbt) {
            super(StructurePieceType.END_CITY, nbt, manager, (identifier) -> {
